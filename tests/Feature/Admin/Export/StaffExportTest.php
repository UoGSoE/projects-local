...
class StaffExportTest extends TestCase
{
    ...
    public function the_staff_exporter_produces_the_expected_data()
    {
        ...
        $project1 = create(Project::class, ['category' => 'undergrad', 'type' => 'B.Eng', 'staff_id' => $staff1->id, 'max_students' => 1]);
        $project2 = create(Project::class, ['category' => 'undergrad', 'type' => 'B.Eng', 'staff_id' => $staff1->id, 'max_students' => 1]);
        $project3 = create(Project::class, ['category' => 'postgrad', 'staff_id' => $staff1->id, 'max_students' => 2]);
        $project4 = create(Project::class, ['category' => 'undergrad', 'type' => 'B.Eng', 'staff_id' => $staff2->id, 'max_students' => 2]);
        $project5 = create(Project::class, ['category' => 'undergrad', 'type' => 'B.Eng', 'staff_id' => $staff2->id, 'max_students' => 1]);
        ...
        Excel::assertDownloaded('uog_project_staff.xlsx', function (StaffExport $export) use ($admin, $staff1, $staff2) {
            ...
            $this->assertEquals(2, $export->collection()[1]['ugrad_beng_active']);
            $this->assertEquals(2, $export->collection()[1]['ugrad_beng_allocated']);
            $this->assertEquals(1, $export->collection()[1]['pgrad_active']);
            $this->assertEquals(0, $export->collection()[1]['pgrad_allocated']);
            $this->assertEquals(0, $export->collection()[1]['second_ugrad_beng_active']);
            $this->assertEquals(0, $export->collection()[1]['second_ugrad_beng_allocated']);
            $this->assertEquals(0, $export->collection()[1]['second_pgrad_active']);
            $this->assertEquals(0, $export->collection()[1]['second_pgrad_allocated']);
            ...
            $this->assertEquals(2, $export->collection()[2]['ugrad_beng_active']);
            $this->assertEquals(1, $export->collection()[2]['ugrad_beng_allocated']);
            $this->assertEquals(0, $export->collection()[2]['pgrad_active']);
            $this->assertEquals(0, $export->collection()[2]['pgrad_allocated']);
            $this->assertEquals(0, $export->collection()[2]['second_ugrad_beng_active']);
            $this->assertEquals(0, $export->collection()[2]['second_ugrad_beng_allocated']);
            $this->assertEquals(0, $export->collection()[2]['second_pgrad_active']);
            $this->assertEquals(0, $export->collection()[2]['second_pgrad_allocated']);
            ...
            $this->assertEquals(0, $export->collection()[3]['ugrad_beng_active']);
            $this->assertEquals(0, $export->collection()[3]['ugrad_beng_allocated']);
            $this->assertEquals(0, $export->collection()[3]['pgrad_active']);
            $this->assertEquals(0, $export->collection()[3]['pgrad_allocated']);
            $this->assertEquals(0, $export->collection()[3]['second_ugrad_beng_active']);
            $this->assertEquals(0, $export->collection()[3]['second_ugrad_beng_allocated']);
            $this->assertEquals(0, $export->collection()[3]['second_pgrad_active']);
            $this->assertEquals(0, $export->collection()[3]['second_pgrad_allocated']);
